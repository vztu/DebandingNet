...
%% Configs %%
curr_dir = pwd;
data_names = {'source01', 'source02', 'source03', 'source04', 'source05',...
    'source06', 'source07', 'source08', 'source09', 'source10'};

for nn = 1:length(data_names)

data_name = data_names{nn};
data_dir = fullfile('../data/Waterloo1K_vp9', data_name);
result_dir = 'result';
% video parameters
...
for i = 1:length(test_seqs)
    ...
    % get framerate
    framerate = round(str2double(extractAfter(name,8)));
